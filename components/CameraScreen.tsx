    ...
    <div className="fixed inset-0 z-50 bg-black flex flex-col overflow-hidden touch-none safe-area-inset">
      <div className="relative flex-1 bg-black overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute inset-0 z-10 flex flex-col pointer-events-none">
          ...
          <footer className={`w-full bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col items-center pointer-events-auto transition-all duration-500 ${isLandscape ? 'px-12 pt-2' : 'pt-6'}`}>
