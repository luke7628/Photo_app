...
const ImagePreviewScreen: React.FC<ImagePreviewScreenProps> = ({ 
  ...
  return (
    <div className="absolute inset-0 z-[100] bg-black flex flex-col overflow-hidden touch-none"
      ...
      <header 
        className="absolute top-0 inset-x-0 px-4 pb-12 bg-gradient-to-b from-black/80 via-transparent z-20 flex items-center justify-between pointer-events-none"
